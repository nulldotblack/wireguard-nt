...
//!     let adapter = match wireguard::Adapter::open(&wireguard, "WireGuard", "Demo") {
//!         Ok(a) => a,
//!         Err(_) =>
//!             //If loading failed (most likely it didn't exist), create a new one
//!             wireguard::Adapter::create(&wireguard, "WireGuard", "Demo", None).expect("Failed to create wireguard adapter!").adapter,
//!     };
//!
//!     todo!();
...
{
    Ok(Arc::new(wireguard_nt_raw::wireguard::from_library(library)?))
}
